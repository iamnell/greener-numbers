...
export function SiteFooter() { return <footer className="platform-footer"><div><Link className="wordmark" href="/"><span>GREENER</span> NUMBERS</Link><p>The economics of going green.</p></div><nav aria-label="Footer navigation"><Link href="/calculators">Calculators</Link><Link href="/videos">Videos</Link><Link href="/incentives">Incentives</Link><Link href="/energy-data">Energy Data</Link><Link href="/ev">EV & Transportation</Link><Link href="/contact">Contact</Link><Link href="/editorial-policy">Editorial Policy</Link><Link href="/authors/greener-numbers-editorial-team">Authors</Link><Link href="/sources">Sources</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/affiliate-disclosure">Affiliate Disclosure</Link><Link href="/corrections-policy">Corrections Policy</Link></nav><small>© 2026 Greener Numbers. Educational information, not financial, tax, legal, or engineering advice.</small></footer>; }
