...
import { ShortsGrid, getGreenerNumbersShorts } from "../../components/latest-shorts";
...
export default async function Videos() {
  const [videos, shorts] = await Promise.all([getPublishedVideos(50), getGreenerNumbersShorts(12)]);
