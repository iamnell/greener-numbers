...
export const metadata: Metadata = pageMetadata({ title: "EV Charging Guides | Greener Numbers", description: "Source-aware explainers on EV charging, home chargers, time-of-use rates, and operating costs.", path: "/ev/guides" });
