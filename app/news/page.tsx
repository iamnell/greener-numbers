...
const stories = [
  { href: "/news/bls-july-2026-household-energy-costs", label: "Household energy costs · August 27, 2026", title: "July CPI: electricity and piped-gas prices rose while the overall energy index fell for the month.", description: "What the federal consumer-price data establish—and why they do not replace a local utility bill or tariff.", note: "Primary federal data · Facts and limits separated" },
