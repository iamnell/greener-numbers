...
export const metadata: Metadata = pageMetadata({ title: "Energy cost calculators | Greener Numbers", description: "Practical, transparent calculators for electricity bills, appliances, EVs, solar, home energy, and energy inflation.", path: "/tools" });
