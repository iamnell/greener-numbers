...
import { articles, resourcePages, siteUrl, sourceLinks, stateData } from "../../lib/content";
...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="article-page">
    ...
    <article className="article-body">
      ...
      <p className="article-date">Published {article.published} · Educational analysis, not financial advice.</p>
